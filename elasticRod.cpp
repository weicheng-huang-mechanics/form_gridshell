...
elasticRod::elasticRod(MatrixXd initialNodes, MatrixXd undeformed, 
	...
	double m_youngM, double m_shearM, double m_rodLength, VectorXd m_theta, MatrixXi m_contactMapping)
{
	...
	contactMapping = m_contactMapping;
	contact_local_num = contactMapping.rows();
